...
> **_NOTE:_**  Not all data in the package is used in this application.

> **_NOTE:_**  We are only using observations that have a randomization indicator of `1` for this application.
...
- `randomization`: Treatment randomization data. CTN-30 has two randomization events.
    ...
    - `which`: randomization indicator, has values 1 and 2 (for CTN-30) in the original data, but only values of 1 in this dashboard.
...
- `uds`: Urine drug screening.
    - `what`: Name of drug identified: Alcohol, Amphetamine, Benzodiazepine, Buprenorphine, Cocaine, Mdma/Hallucinogen, Methadone, Opioid, Sedatives, Thc
